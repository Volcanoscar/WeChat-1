...
//		 return dnum;
	...
	public static String getMacAddr(){
		...
		WifiManager wifi = (WifiManager) WeChatApplication.gContext.getSystemService(Context.WIFI_SERVICE);  
...
//		 return huanid;
	...
	public static   ArrayList<AppInfo> getSystemApp(Context mContext)
	{
		...
		File file;
		String clientTypeModel = SystemInfoUtil.getClienttype(mContext);
	...
	public static String getPackageName(){
		return WeChatApplication.gContext.getPackageName();
	}
	
	
	public static String get_apkver() 
	{ 	     
		Context context = WeChatApplication.gContext;
